...
And that's it! It should not be possible for anyone to recreate the figures from the accompanying article and explore the data in other interactive and manual ways. There is a lot that can be explored in these data, so hopefully, others will find this report useful! I will conclude by displaying my session info, which may be useful for troubleshooting if issues are encountered.
